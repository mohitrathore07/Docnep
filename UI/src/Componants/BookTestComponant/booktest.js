...
const TestAppointment = () => {
  ...
  useEffect(()=>{
    axios.get(_addtestapiurl+"fetch?_id="+params._id).then((response)=>{        
          ...
          drdetails.map((row)=>{
            return (
              <div className="appointment-details-content">
                <div className="appointment-content">Test Name: {row.TestName}</div>
                <div className="appointment-content">Test Type:  {row.Testtype}</div>
                <div className="appointment-content">Fees:  {row.Fees}</div>
